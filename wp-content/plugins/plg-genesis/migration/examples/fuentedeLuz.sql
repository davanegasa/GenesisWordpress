...
SELECT pg_catalog.setval('estudiantes_cursos_id_seq', 1454, true);
...
COPY niveles_programas (id, programa_id, nombre) FROM stdin;
4	1	Nivel 1
5	1	Nivel 2
6	1	Nivel 3
7	2	Nivel 1
...
COPY programas (id, nombre, descripcion) FROM stdin;
1	Programa Niños (nuevo)	
2	Programa Niños (antiguo)	
3	Programa Adolescentes (nuevo)	
4	Programa Adolescentes (Antiguo)	
5	Programa Adultos (nuevo)	
6	Programa Adultos (Antiguo)	
7	Programa Colegios	
\.
...
COPY programas_asignaciones (id, programa_id, estudiante_id, contacto_id, fecha_asignacion) FROM stdin;
\.
...
COPY programas_cursos (id, programa_id, curso_id, nivel_id, consecutivo) FROM stdin;
129	2	26	7	1
130	2	27	7	2
131	2	28	7	3
132	2	29	7	4
