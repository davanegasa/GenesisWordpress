...
// Verificar si el usuario no estив autenticado en WordPress
if (!is_user_logged_in()) {
    wp_redirect(wp_login_url());  // Redirigir a la pивgina de login de WordPress
    exit;
}
...
if ($result_estudiantes && pg_num_rows($result_estudiantes) > 0) {
    ...
    do {
        ...
        $pdf->Cell(0, 10, "Cиоdigo: " . $contacto['id_estudiante'], 0, 1);
