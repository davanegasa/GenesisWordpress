...
// Obtener parámetros
$id_congreso = isset($_GET['id']) ? intval($_GET['id']) : 0;
...
<body>
    ...
    <script>
        ...
        document.getElementById('scannerInput').addEventListener('input', function(e) {
            ...
            // Esperar 100ms para asegurarse de que se complete el escaneo
        ...
        function procesarCodigo(codigo) {
            // Extraer número de boleta y código de verificación
