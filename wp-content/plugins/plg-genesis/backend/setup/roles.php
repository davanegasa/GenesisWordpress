	...
	public static function get_role_capabilities() {
		return [
			...
			'plg_office_viewer' => [
				...
				'plg_view_students' => true,
				'plg_view_courses' => true,
				'plg_view_programs' => true,
				'plg_view_contacts' => true,
				'plg_view_events' => true,
				'plg_view_stats' => true,
				'plg_view_theme' => true,
			],
			...
			'plg_office_staff' => [
				'read' => true,
				'plg_view_students' => true,
				'plg_create_students' => true,
				'plg_edit_students' => true,
				'plg_view_courses' => true,
				'plg_assign_courses' => true,
				'plg_view_programs' => true,
				'plg_view_contacts' => true,
				'plg_create_contacts' => true,
				'plg_edit_contacts' => true,
				'plg_view_events' => true,
				'plg_create_events' => true,
				'plg_edit_events' => true,
				'plg_view_stats' => true,
				'plg_view_theme' => true,
				'plg_view_swagger' => true,
			],
			...
			'plg_office_manager' => [
				...
				'plg_create_students' => true,
				'plg_edit_students' => true,
				'plg_delete_students' => true,
				// Cursos: full CRUD
				'plg_view_courses' => true,
				'plg_assign_courses' => true,
				'plg_create_courses' => true,
				'plg_edit_courses' => true,
				'plg_delete_courses' => true,
				// Programas: full CRUD
				'plg_view_programs' => true,
				'plg_create_programs' => true,
				'plg_edit_programs' => true,
				'plg_delete_programs' => true,
				// Contactos: full CRUD
				'plg_view_contacts' => true,
				'plg_create_contacts' => true,
				'plg_edit_contacts' => true,
				'plg_delete_contacts' => true,
				// Congresos: full CRUD
				'plg_view_events' => true,
				'plg_create_events' => true,
				'plg_edit_events' => true,
				'plg_delete_events' => true,
				// Estadísticas: ver y exportar
				'plg_view_stats' => true,
				'plg_export_stats' => true,
				// Tema: ver y cambiar
				'plg_view_theme' => true,
				'plg_change_theme' => true,
				// Usuarios: gestión completa de su oficina
				'plg_view_users' => true,
				'plg_create_users' => true,
				'plg_edit_users' => true,
				'plg_delete_users' => true,
				// Swagger
				'plg_view_swagger' => true,
			],
